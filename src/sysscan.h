...
/**
 * This is the "operationg" to be performed by sysscan, which is almost always
...
/**
 * This is the master sysscan configuration structure. It is created on startup
...
void sysscan_read_config_file(struct sysscan *sysscan, const char *filename);
void sysscan_command_line(struct sysscan *sysscan, int argc, char *argv[]);
void sysscan_usage(void);
void sysscan_save_state(struct sysscan *sysscan);
void main_listscan(struct sysscan *sysscan);
